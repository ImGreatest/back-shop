-- CreateEnum
CREATE TYPE "EProductStatus" AS ENUM ('stock', 'absent');

-- CreateEnum
CREATE TYPE "ERoleUser" AS ENUM ('admin', 'seller', 'client');
...
CREATE TABLE "Product" (
    ...
    "status" "EProductStatus" NOT NULL DEFAULT 'absent',
    "createdAt" TIMESTAMPTZ(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMPTZ(3) NOT NULL,
    "deletedAt" TIMESTAMPTZ(3),
...
CREATE TABLE "User" (
    ...
    "role" "ERoleUser" NOT NULL DEFAULT 'client',
    "login" TEXT NOT NULL,
